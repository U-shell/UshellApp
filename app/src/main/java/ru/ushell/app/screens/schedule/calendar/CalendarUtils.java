package ru.ushell.app.screens.schedule.calendar;
...
public class CalendarUtils {
    ...
    public static Integer DaysInAWeek = 6;
    ...
    public static String DayOfWeek(LocalDate date) {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("EEEE", new Locale("RU", "com"));
        return date.format(formatter);
    }
    ...
    public static ArrayList<LocalDate> daysInWeekArray(LocalDate selectedDate) {
        ...
        LocalDate endDate = current.plusDays(DaysInAWeek);
    ...
    public static ArrayList<LocalDate> daysInMonthArray(LocalDate date) {
        ...
        for (int i = 2; i <= 42; i++){
            ...
            if (i <= dayOfWeek || i > daysInMonth + dayOfWeek|| count == 7) {
                if (count == 7) count = 0;
    ...
    public static String FormatDataCome(LocalDate date) {
        ...
        return String.format("%s_%s_%s", reformat[0], reformat[1], reformat[2]);
    }

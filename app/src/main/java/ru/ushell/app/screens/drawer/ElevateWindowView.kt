...
//        modifier = Modifier
//            .background(
//                color = _root_ide_package_.ru.ushell.app.old.ui.theme.LightBackgroundColor,
...
//@Composable
//fun Exit() {
//    _root_ide_package_.ru.ushell.app.old.models.modelTimeTable.lesson.Lesson.LessonsList.clear()
//    _root_ide_package_.ru.ushell.app.old.models.modelTimeTable.lesson.Lesson.Secondary.clear()
//    _root_ide_package_.ru.ushell.app.old.models.modelTimeTable.attendance.AttendanceStudent.AttendanceStudentList.clear()
//    _root_ide_package_.ru.ushell.app.old.models.modelTimeTable.attendance.AttendanceGroup.AttendanceGroupList.clear()
//    Log.i(" databaseHelperMain.deleteTable()"," databaseHelperMain.deleteTable()")
//    _root_ide_package_.ru.ushell.app.old.api.Service.databaseHelperMain.deleteAllData()
//    _root_ide_package_.ru.ushell.app.old.models.eClass.User.clear()
//    _root_ide_package_.ru.ushell.app.old.utils.SavingSession.SaveUser.userLogOut(LocalContext.current)
//}
//
//@Preview
//@Composable

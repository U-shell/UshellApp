...
//@Composable
//fun Message(
//    msg: ru.ushell.app.old.models.modelChat.message.Message,
...
//@Composable
//fun ChatItemBubble(
//    message: ru.ushell.app.old.models.modelChat.message.Message,
//) {
//
...
//    ChatItemBubble(
//        message = _root_ide_package_.ru.ushell.app.old.models.modelChat.message.Message(
//            author = true,
//            content = "hi",

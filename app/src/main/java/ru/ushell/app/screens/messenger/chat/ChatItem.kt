...
//        Text(
//            text = nameChat,
//            style = _root_ide_package_.ru.ushell.app.old.ui.theme.NameChatElected
//        )
//    }
//}
//@Composable
...
//    statusNoise: Int
//){
//    val status = mapOf(0 to Color.Transparent, 1 to _root_ide_package_.ru.ushell.app.old.ui.theme.ChatNotingBackground)
//
//    ConstraintLayout(
//        modifier = Modifier
//            .padding(
...
//            if (isRefreshing) {
//
//                _root_ide_package_.ru.ushell.app.old.api.Service()
//                    .getMessageChat(_root_ide_package_.ru.ushell.app.old.models.eClass.User.getKeyIdUserChat(), lastMessage)
//
//                delay(2000)
//                isRefreshing = false
//            }
//        }
//
//        navController.navigate(_root_ide_package_.ru.ushell.app.old.ui.screens.chatScreen.RoutesChat.ScreenDialog.route)
...
//    statusNoise: Boolean
//){
//    val status = mapOf(false to Color.Transparent, true to _root_ide_package_.ru.ushell.app.old.ui.theme.ChatNotingBackground)
...
//                                Text(
//                                    text = titleChat,
//                                    style = _root_ide_package_.ru.ushell.app.old.ui.theme.NameChatTitle
//                                )
//                            }
//                            Row {
//                                Text(
//                                    text = lastUser,
//                                    style = _root_ide_package_.ru.ushell.app.old.ui.theme.NameChatDes
//                                )
//                                Text(
//                                    text = ": ",
//                                    style = _root_ide_package_.ru.ushell.app.old.ui.theme.NameChatDes
